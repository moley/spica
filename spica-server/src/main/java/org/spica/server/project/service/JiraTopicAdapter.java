 ...
 */
@Service
public class JiraTopicAdapter implements ExternalSystemTopicAdapter {
    ...
    @Override
    public Collection<TopicInfo> getTopicsOfUser(ExternalSystem externalSystem) {
        JiraRestClient jiraRestClient = getRestClient(externalSystem);
        Collection<TopicInfo> topicsFromJira = new ArrayList<TopicInfo>();
