...
public class ModelTest {
    ...
    @Test
    public void getUserNotNull () throws NotFoundException {
        Model model = new Model();
        ...
        UserInfo userInfo = model.getUserNotNull("@user");
        Assert.assertEquals (2, model.getUserInfos().size());
        Assert.assertEquals (userInfo, model.getUserInfos().get(1));
        Assert.assertNotNull (userInfo.getId());
        Assert.assertEquals("user", userInfo.getUsername());

        UserInfo userInfo2 = model.getUserNotNull("other.user@spica.org");
        Assert.assertEquals (3, model.getUserInfos().size());
        Assert.assertEquals (userInfo2, model.getUserInfos().get(2));
    ...
    public void getUserNotNullInvalidId () throws NotFoundException {
        Model model = new Model();
    ...
    @Test
    public void getOtherUsers () throws NotFoundException {
        ...
        messagecontainerInfo.addMessageItem(new MessageInfo().addRecieversToItem("externalUser@spica.org").creator("@me")); //me->externalUser
    ...
    @Test
    public void findUserBySearchString () throws NotFoundException {
    ...
    @Test(expected = NotFoundException.class)
    public void findUserBySearchStringNull () throws NotFoundException {
    ...
    @Test(expected = NotFoundException.class)
    public void findUserBySearchStringEmpty () throws NotFoundException {
    ...
    @Test(expected = NotFoundException.class)
    public void findUserBySearchStringNotFound () throws NotFoundException {
