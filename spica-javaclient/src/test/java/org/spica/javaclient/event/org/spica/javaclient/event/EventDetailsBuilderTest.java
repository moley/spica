...
public class EventDetailsBuilderTest {
    ...
    public void details () {
        ...
        modelCache.getEventInfosReal().add(createEvent(LocalTime.of(8,0), LocalTime.of(9,0), EventType.TOPIC));
        modelCache.getEventInfosReal().add(createEvent(LocalTime.of(9,0), LocalTime.of(10,0), EventType.PAUSE));
        modelCache.getEventInfosReal().add(createEvent(LocalTime.of(10,0), LocalTime.of(10,30), EventType.MESSAGE));
        EventDetailsBuilder eventDetailsBuilder = new EventDetailsBuilder();
        eventDetailsBuilder.setModelCache(modelCache);
