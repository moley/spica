...
public class CloneProjectAction extends AbstractProjectAction {
  ...
  @Override public void execute(ActionContext actionContext, InputParams inputParams,
    ...
    final String username = actionContext.getSpicaProperties().getValue("spica.stash.user");
    final String password = actionContext.getSpicaProperties().getValue("spica.stash.password");
