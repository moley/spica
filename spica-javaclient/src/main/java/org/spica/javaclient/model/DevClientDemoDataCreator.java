...
public class DevClientDemoDataCreator {
    ...
    public final static void main (final String [] args) {
        ...
        model.setEventInfosReal(new ArrayList<>(Arrays.asList(task1, pause1, task2, pause2, task3)));
        ...
        model.setTopicInfos(new ArrayList<>(Arrays.asList(topicInfo1, topicInfo2, topicInfo3)));
        ...
        model.setUserInfos(new ArrayList<>(Arrays.asList(userInfo1, userInfo2)));





        modelCacheService.set(model, "Creating demo data");
