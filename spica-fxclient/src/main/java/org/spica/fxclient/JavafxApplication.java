...
import org.spica.fxclient.controllers.MainController;
import org.spica.fxclient.controllers.Pages;
import org.spica.javaclient.demodata.CreateDemoDataClient;
...
public class JavafxApplication extends Application {
  ...
  @Override public void start(final Stage stage) {
    ...
    if (new File("build.gradle").exists()) {
      ...
      createDemoDataClient.main(new String []{});
    }
    ...
    Screen primary = screenManager.getExternalOrPrimaryScreen();
